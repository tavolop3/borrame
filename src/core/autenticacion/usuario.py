...
#     "usuario_tiene_rol",
#     db.Column(
#         "institucion_id", db.Integer, db.ForeignKey("institucion.id"), nullable=True
#     ),
...
class Usuario(db.Model):
    ...
    # Define la relación muchos a muchos con Institucion
    instituciones = db.relationship('Institucion', secondary=usuarios_instituciones, backref=db.backref('usuarios', lazy='dynamic'))
